...
This project defines a unified schema and transformation policy
to make market data immediately analytics-ready.
...
- We define trade_value as close * volume when not provided,
- to ensure consistent cross-exchange comparison aligned with candle close price.
